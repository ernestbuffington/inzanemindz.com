...
// eXtreme Styles mod cache. Generated on Wed, 26 Apr 2023 21:58:56 +0000 (time=1682546336)

?><!-- BEGIN groups title -->
<?php echo isset($this->vars['GROUPS_TITLE']) ? $this->vars['GROUPS_TITLE'] : $this->lang('GROUPS_TITLE'); ?>
<!-- END groups title -->
    ...
    <td class="row2" align="right">
      ...
      <table width="90%" cellspacing="0" cellpadding="0" border="0">
            ...
            <td align="center" width="30%"> 
              <input type="submit" value="<?php echo isset($this->vars['L_VIEW_INFORMATION']) ? $this->vars['L_VIEW_INFORMATION'] : $this->lang('L_VIEW_INFORMATION'); ?>" class="titaniumbutton" />
