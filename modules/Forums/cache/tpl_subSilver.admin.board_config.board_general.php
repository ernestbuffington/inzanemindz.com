...
<table cellpadding="4" cellspacing="1" border="0" class="forumline" style="width: 99%;">
  ...
  <tr>
    ...
    <td class="row2" style="height: 35px; width: 50%;"><input type="radio" name="override_nuke_user_style" value="1" <?php echo isset($this->vars['OVERRIDE_STYLE_YES']) ? $this->vars['OVERRIDE_STYLE_YES'] : $this->lang('OVERRIDE_STYLE_YES'); ?> /> <?php echo isset($this->vars['L_YES']) ? $this->vars['L_YES'] : $this->lang('L_YES'); ?> <input type="radio" name="override_nuke_user_style" value="0" <?php echo isset($this->vars['OVERRIDE_STYLE_NO']) ? $this->vars['OVERRIDE_STYLE_NO'] : $this->lang('OVERRIDE_STYLE_NO'); ?> /> <?php echo isset($this->vars['L_NO']) ? $this->vars['L_NO'] : $this->lang('L_NO'); ?></td>
  </tr>
  <!-- Quick Search -->
  <tr>
    <td class="row1" style="height: 35px; width: 50%;">
