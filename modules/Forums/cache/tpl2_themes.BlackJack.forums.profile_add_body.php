...
// eXtreme Styles mod cache. Generated on Thu, 27 Apr 2023 22:33:52 +0000 (time=1682634832)
...
?>
  <tr>
    ...
    <td class="row2" style="width: 50%;"><input type="submit" name="avatargallery" value="<?php echo isset($this->vars['L_SHOW_GALLERY']) ? $this->vars['L_SHOW_GALLERY'] : $this->lang('L_SHOW_GALLERY'); ?>" class="titaniumbutton" /></td>
  </tr>
  <?php
...
?>
  <tr>
    <td class="catBottom" colspan="2" style=" text-align: center;"><?php echo isset($this->vars['S_HIDDEN_FIELDS']) ? $this->vars['S_HIDDEN_FIELDS'] : $this->lang('S_HIDDEN_FIELDS'); ?><input type="submit" name="submit" value="<?php echo isset($this->vars['L_SUBMIT']) ? $this->vars['L_SUBMIT'] : $this->lang('L_SUBMIT'); ?>" class="mainoption" />&nbsp;&nbsp;<input type="reset" value="<?php echo isset($this->vars['L_RESET']) ? $this->vars['L_RESET'] : $this->lang('L_RESET'); ?>" name="reset" class="titaniumbutton" /></td>
  </tr>
</table>
<!--	QUICK REPLY PANEL	-->
</form>