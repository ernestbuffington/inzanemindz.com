...
// eXtreme Styles mod cache. Generated on Wed, 26 Apr 2023 21:34:08 +0000 (time=1682544848)
        ...
        <tr>
          ...
          <td class="row1" nowrap="nowrap">
            <select name="sort" class="post">
              ...
              <option value="nuke_user_regdate"<?php echo isset($this->vars['SELECTED_JOINED']) ? $this->vars['SELECTED_JOINED'] : $this->lang('SELECTED_JOINED'); ?>><?php echo isset($this->vars['L_SORT_JOINED']) ? $this->vars['L_SORT_JOINED'] : $this->lang('L_SORT_JOINED'); ?></option>
              ...
              <option value="nuke_user_posts"<?php echo isset($this->vars['SELECTED_POSTS']) ? $this->vars['SELECTED_POSTS'] : $this->lang('SELECTED_POSTS'); ?>><?php echo isset($this->vars['L_SORT_POSTS']) ? $this->vars['L_SORT_POSTS'] : $this->lang('L_SORT_POSTS'); ?></option>
              <option value="nuke_user_rank"<?php echo isset($this->vars['SELECTED_RANK']) ? $this->vars['SELECTED_RANK'] : $this->lang('SELECTED_RANK'); ?>><?php echo isset($this->vars['L_SORT_RANK']) ? $this->vars['L_SORT_RANK'] : $this->lang('L_SORT_RANK'); ?></option>
