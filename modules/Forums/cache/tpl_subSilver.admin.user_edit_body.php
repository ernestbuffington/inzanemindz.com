...
// eXtreme Styles mod cache. Generated on Wed, 26 Apr 2023 21:34:17 +0000 (time=1682544857)
...
?>
    ...
    <tr>
      ...
      <td class="row2"><input type="text" name="nuke_user_posts" value="<?php echo isset($this->vars['USER_POSTS']) ? $this->vars['USER_POSTS'] : $this->lang('USER_POSTS'); ?>"></select></td>
    </tr>
    <tr>
      <td class="row1"><?php echo isset($this->vars['L_SELECT_RANK1']) ? $this->vars['L_SELECT_RANK1'] : $this->lang('L_SELECT_RANK1'); ?></td>
      <td class="row2"><select name="nuke_user_rank"><?php echo isset($this->vars['RANK1_SELECT_BOX']) ? $this->vars['RANK1_SELECT_BOX'] : $this->lang('RANK1_SELECT_BOX'); ?></select></td>
	</tr>
	<tr>
