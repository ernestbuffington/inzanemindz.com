...
// eXtreme Styles mod cache. Generated on Wed, 26 Apr 2023 21:49:35 +0000 (time=1682545775)

?><form action="<?php echo isset($this->vars['S_GROUPCP_ACTION']) ? $this->vars['S_GROUPCP_ACTION'] : $this->lang('S_GROUPCP_ACTION'); ?>" method="post">
<!-- BEGIN groups title -->
<?php echo isset($this->vars['GROUPS_LIST_INFO']) ? $this->vars['GROUPS_LIST_INFO'] : $this->lang('GROUPS_LIST_INFO'); ?>
<!-- END groups title -->
<table border="0" cellpadding="4" cellspacing="1" class="acenter" style="width: 100%">
    <tr>
        <td class="aleft"><span class="over-ride"><?php echo isset($this->vars['GROUPS_LINK']) ? $this->vars['GROUPS_LINK'] : $this->lang('GROUPS_LINK'); ?><?php echo isset($this->vars['GROUPS_LIST_INFO_LINK']) ? $this->vars['GROUPS_LIST_INFO_LINK'] : $this->lang('GROUPS_LIST_INFO_LINK'); ?></span></td>
    </tr>
</table>
...
<table border="0" cellpadding="4" cellspacing="1" class="forumline" style="width: 100%">
    ...
    <tr> 
        <td class="row1" width="20%"><span class="over-ride"><strong><?php echo isset($this->vars['L_GROUP_NAME']) ? $this->vars['L_GROUP_NAME'] : $this->lang('L_GROUP_NAME'); ?>:</strong></span></td>
        <td class="row2"><span class="over-ride"><?php echo isset($this->vars['GROUP_NAME']) ? $this->vars['GROUP_NAME'] : $this->lang('GROUP_NAME'); ?></span></td>
    </tr>
    <tr> 
        <td class="row1" width="20%"><span class="over-ride"><strong><?php echo isset($this->vars['L_GROUP_DESC']) ? $this->vars['L_GROUP_DESC'] : $this->lang('L_GROUP_DESC'); ?>:</strong></span></td>
        <td class="row2"><span class="over-ride"><?php echo isset($this->vars['GROUP_DESC']) ? $this->vars['GROUP_DESC'] : $this->lang('GROUP_DESC'); ?></span></td>
    </tr>
    <tr> 
        <td class="row1" width="20%"><span class="over-ride"><strong><?php echo isset($this->vars['L_GROUP_MEMBERSHIP']) ? $this->vars['L_GROUP_MEMBERSHIP'] : $this->lang('L_GROUP_MEMBERSHIP'); ?>:</strong></span></td>
        <td class="row2"><span class="over-ride"><?php echo isset($this->vars['GROUP_DETAILS']) ? $this->vars['GROUP_DETAILS'] : $this->lang('GROUP_DETAILS'); ?></span>
        <?php
...
?>
        <input class="btn-hover-two" type="submit" name="joingroup" value="<?php echo isset($this->vars['L_JOIN_GROUP']) ? $this->vars['L_JOIN_GROUP'] : $this->lang('L_JOIN_GROUP'); ?>" />
        <?php
...
?>
        <input class="btn-hover-two" type="submit" name="unsub" value="<?php echo isset($this->vars['L_UNSUBSCRIBE_GROUP']) ? $this->vars['L_UNSUBSCRIBE_GROUP'] : $this->lang('L_UNSUBSCRIBE_GROUP'); ?>" />
        <?php
...
?>
    <tr> 
        <td class="row1" width="20%"><span class="over-ride"><strong><?php echo isset($this->vars['L_GROUP_TYPE']) ? $this->vars['L_GROUP_TYPE'] : $this->lang('L_GROUP_TYPE'); ?>:</strong></span></td>
        <td class="row2" align="left"><input style="vertical-align: middle" type="radio" name="group_type" value="<?php echo isset($this->vars['S_GROUP_OPEN_TYPE']) ? $this->vars['S_GROUP_OPEN_TYPE'] : $this->lang('S_GROUP_OPEN_TYPE'); ?>" <?php echo isset($this->vars['S_GROUP_OPEN_CHECKED']) ? $this->vars['S_GROUP_OPEN_CHECKED'] : $this->lang('S_GROUP_OPEN_CHECKED'); ?>/>&nbsp;<span class="over-ride"><?php echo isset($this->vars['L_GROUP_OPEN']) ? $this->vars['L_GROUP_OPEN'] : $this->lang('L_GROUP_OPEN'); ?></span>&nbsp;<input style="vertical-align: middle" type="radio" name="group_type" value="<?php echo isset($this->vars['S_GROUP_CLOSED_TYPE']) ? $this->vars['S_GROUP_CLOSED_TYPE'] : $this->lang('S_GROUP_CLOSED_TYPE'); ?>" <?php echo isset($this->vars['S_GROUP_CLOSED_CHECKED']) ? $this->vars['S_GROUP_CLOSED_CHECKED'] : $this->lang('S_GROUP_CLOSED_CHECKED'); ?>/>&nbsp;<span class="over-ride"><?php echo isset($this->vars['L_GROUP_CLOSED']) ? $this->vars['L_GROUP_CLOSED'] : $this->lang('L_GROUP_CLOSED'); ?></span>&nbsp;<input style="vertical-align: middle" type="radio" name="group_type" value="<?php echo isset($this->vars['S_GROUP_HIDDEN_TYPE']) ? $this->vars['S_GROUP_HIDDEN_TYPE'] : $this->lang('S_GROUP_HIDDEN_TYPE'); ?>" <?php echo isset($this->vars['S_GROUP_HIDDEN_CHECKED']) ? $this->vars['S_GROUP_HIDDEN_CHECKED'] : $this->lang('S_GROUP_HIDDEN_CHECKED'); ?>/>&nbsp;<span class="over-ride"><?php echo isset($this->vars['L_GROUP_HIDDEN']) ? $this->vars['L_GROUP_HIDDEN'] : $this->lang('L_GROUP_HIDDEN'); ?></span>&nbsp;<input class="btn-hover-two" type="submit" name="groupstatus" value="<?php echo isset($this->vars['L_UPDATE']) ? $this->vars['L_UPDATE'] : $this->lang('L_UPDATE'); ?>" /></td>
    </tr>
    <?php
...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
    <tr> 
      ...
      <td class="catHead" align="center"><?php echo isset($this->vars['L_FROM']) ? $this->vars['L_FROM'] : $this->lang('L_FROM'); ?></td>
    ...
    <tr> 
      ...
      <td class="row1"><?php echo isset($this->vars['MOD_CURRENT_AVATAR']) ? $this->vars['MOD_CURRENT_AVATAR'] : $this->lang('MOD_CURRENT_AVATAR'); ?><a href="<?php echo isset($this->vars['U_MOD_VIEWPROFILE']) ? $this->vars['U_MOD_VIEWPROFILE'] : $this->lang('U_MOD_VIEWPROFILE'); ?>"><?php echo isset($this->vars['MOD_USERNAME']) ? $this->vars['MOD_USERNAME'] : $this->lang('MOD_USERNAME'); ?></a></td>
      <td class="row1 acenter" valign="middle"><?php echo isset($this->vars['MOD_POSTS']) ? $this->vars['MOD_POSTS'] : $this->lang('MOD_POSTS'); ?></td>
      <td class="row1" align="center"><?php echo isset($this->vars['MOD_FLAG']) ? $this->vars['MOD_FLAG'] : $this->lang('MOD_FLAG'); ?><?php echo isset($this->vars['MOD_FROM']) ? $this->vars['MOD_FROM'] : $this->lang('MOD_FROM'); ?>
        <!-- <table border="0">
          <tr>
...
?>
    <tr> 
      ...
      <td class="<?php echo isset($member_row_item['ROW_CLASS']) ? $member_row_item['ROW_CLASS'] : ''; ?>"><?php echo isset($member_row_item['CURRENT_AVATAR']) ? $member_row_item['CURRENT_AVATAR'] : ''; ?> <a href="<?php echo isset($member_row_item['U_VIEWPROFILE']) ? $member_row_item['U_VIEWPROFILE'] : ''; ?>"><?php echo isset($member_row_item['USERNAME']) ? $member_row_item['USERNAME'] : ''; ?></a></td>
      ...
      <td class="<?php echo isset($member_row_item['ROW_CLASS']) ? $member_row_item['ROW_CLASS'] : ''; ?>" align="center"><?php echo isset($member_row_item['FLAG']) ? $member_row_item['FLAG'] : ''; ?><?php echo isset($member_row_item['FROM']) ? $member_row_item['FROM'] : ''; ?></td>
...
?>
    <tr>
        <td class="catBottom" colspan="8" align="right">
            <span class="cattitle"><input type="submit" name="remove" value="<?php echo isset($this->vars['L_REMOVE_SELECTED']) ? $this->vars['L_REMOVE_SELECTED'] : $this->lang('L_REMOVE_SELECTED'); ?>" class="btn-hover-one" /></span>
        </td>
    </tr>
    <?php
...
?>
        <br /><input type="text"  class="post" name="username" maxlength="50" size="20" />&nbsp;<input type="submit" name="add" value="<?php echo isset($this->vars['L_ADD_MEMBER']) ? $this->vars['L_ADD_MEMBER'] : $this->lang('L_ADD_MEMBER'); ?>" class="btn-hover-one" /><br /><br /> 
        <?php
...
?>
        ...
        <td align="right" valign="top"><?php echo isset($this->vars['PAGINATION']) ? $this->vars['PAGINATION'] : $this->lang('PAGINATION'); ?></td>
    </tr>
</table>
