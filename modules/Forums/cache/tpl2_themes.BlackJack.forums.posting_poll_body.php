...
// eXtreme Styles mod cache. Generated on Fri, 28 Apr 2023 03:04:11 +0000 (time=1682651051)
...
?>
  <tr>
    ...
    <td class="row2"><input type="text" name="poll_option_text[<?php echo isset($poll_option_rows_item['S_POLL_OPTION_NUM']) ? $poll_option_rows_item['S_POLL_OPTION_NUM'] : ''; ?>]" size="50" class="post" maxlength="255" value="<?php echo isset($poll_option_rows_item['POLL_OPTION']) ? $poll_option_rows_item['POLL_OPTION'] : ''; ?>" /> &nbsp;<input type="submit" name="edit_poll_option" value="<?php echo isset($this->vars['L_UPDATE_OPTION']) ? $this->vars['L_UPDATE_OPTION'] : $this->lang('L_UPDATE_OPTION'); ?>" class="titaniumbutton" /> <input type="submit" name="del_poll_option[<?php echo isset($poll_option_rows_item['S_POLL_OPTION_NUM']) ? $poll_option_rows_item['S_POLL_OPTION_NUM'] : ''; ?>]" value="<?php echo isset($this->vars['L_DELETE_OPTION']) ? $this->vars['L_DELETE_OPTION'] : $this->lang('L_DELETE_OPTION'); ?>" class="titaniumbutton" /></td>
  </tr>
  <?php
