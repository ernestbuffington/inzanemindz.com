...
// eXtreme Styles mod cache. Generated on Wed, 10 May 2023 01:59:32 +0000 (time=1683683972)
...
<form method="post" action="<?php echo isset($this->vars['S_MODE_ACTION']) ? $this->vars['S_MODE_ACTION'] : $this->lang('S_MODE_ACTION'); ?>" name="sort_and_pmtype">
  <table width="100%" cellspacing="2" cellpadding="2" border="0" align="center">
    ...
    </tr><tr>      <td><input type="hidden" name="mode" value="<?php echo isset($this->vars['S_MODE']) ? $this->vars['S_MODE'] : $this->lang('S_MODE'); ?>">&nbsp;</td>
