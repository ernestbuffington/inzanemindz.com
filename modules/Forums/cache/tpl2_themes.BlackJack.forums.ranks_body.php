...
// eXtreme Styles mod cache. Generated on Fri, 28 Apr 2023 13:43:58 +0000 (time=1682689438)
...
<table width="100%" cellspacing="2" cellpadding="2" border="0">
  <tr> 
    <td style="width: 100%"><a href="<?php echo isset($this->vars['U_INDEX']) ? $this->vars['U_INDEX'] : $this->lang('U_INDEX'); ?>"><?php echo isset($this->vars['L_INDEX']) ? $this->vars['L_INDEX'] : $this->lang('L_INDEX'); ?></a> <i class="fa-solid fa-arrow-right fa-lg"></i> <?php echo isset($this->vars['L_RANKS']) ? $this->vars['L_RANKS'] : $this->lang('L_RANKS'); ?></td>
  </tr>
</table>
  ...
  <tr>
    <td valign="top" width="50%">
      <table border="0" cellpadding="4" cellspacing="1" class="forumline" width="100%">
        <tr>
            <td class="catHead" style="text-align: center" colspan="3"><strong><?php echo isset($this->vars['L_RANKS']) ? $this->vars['L_RANKS'] : $this->lang('L_RANKS'); ?></strong></td>
        </tr>
        <tr>
...
?>
    ...
    <td valign="top" width="50%">
        <table border="0" cellpadding="4" cellspacing="1" class="forumline" width="100%">
        <tr>
            <td class="catHead" style="text-align: center" height="25" valign="middle" colspan="2"><strong><?php echo isset($this->vars['L_SPECIAL_RANKS']) ? $this->vars['L_SPECIAL_RANKS'] : $this->lang('L_SPECIAL_RANKS'); ?></strong></td>
        </tr>
        <tr>
