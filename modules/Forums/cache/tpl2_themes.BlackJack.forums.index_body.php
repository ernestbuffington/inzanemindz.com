...
// eXtreme Styles mod cache. Generated on Wed, 10 May 2023 01:49:19 +0000 (time=1683683359)
...
?>
  ...
  <?php if ($forumrow_item['FORUM_ICON_IMG']) {  ?>
	...
	<?php } ?>
	<td class="row1"
    <?php if (! $forumrow_item['FORUM_ICON_IMG']) {  ?> colspan="2"
    <?php } ?>>
	  <a<?php echo isset($forumrow_item['FORUM_COLOR']) ? $forumrow_item['FORUM_COLOR'] : ''; ?> href="<?php echo isset($forumrow_item['U_VIEWFORUM']) ? $forumrow_item['U_VIEWFORUM'] : ''; ?>"
      <?php if ($forumrow_item['FORUM_LINK_COUNT']) {  ?> target="_blank"
      <?php } ?>>
      <?php echo isset($forumrow_item['FORUM_NAME']) ? $forumrow_item['FORUM_NAME'] : ''; ?></a><br />
...
?>
<a class="buttonlink" href="<?php echo isset($this->vars['U_MARK_READ']) ? $this->vars['U_MARK_READ'] : $this->lang('U_MARK_READ'); ?>"><?php echo isset($this->vars['L_MARK_FORUMS_READ']) ? $this->vars['L_MARK_FORUMS_READ'] : $this->lang('L_MARK_FORUMS_READ'); ?></a><?php
...
<table style="text-align: left; background-color :transparent;" class="forumline rounded-corners">
  <tr> 
    <td class="catHead"><a style="text-align: center; background-color :#000000;" class="SMALLbuttonlink" href="<?php echo isset($this->vars['U_VIEWONLINE']) ? $this->vars['U_VIEWONLINE'] : $this->lang('U_VIEWONLINE'); ?>"><?php echo isset($this->vars['L_WHO_IS_ONLINE']) ? $this->vars['L_WHO_IS_ONLINE'] : $this->lang('L_WHO_IS_ONLINE'); ?></a></td>
  </tr>
  <tr> 
