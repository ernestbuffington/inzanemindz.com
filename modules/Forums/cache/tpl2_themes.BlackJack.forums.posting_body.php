...
// eXtreme Styles mod cache. Generated on Wed, 26 Apr 2023 21:20:35 +0000 (time=1682544035)
...
?>
    <i class="fa-solid fa-arrow-right fa-lg"></i> <a href="<?php echo isset($this->vars['U_VIEW_TOPIC']) ? $this->vars['U_VIEW_TOPIC'] : $this->lang('U_VIEW_TOPIC'); ?>"><?php echo isset($this->vars['TOPIC_SUBJECT']) ? $this->vars['TOPIC_SUBJECT'] : $this->lang('TOPIC_SUBJECT'); ?></a>
    <?php
...
?>
  <tr> 
    <td class="row1"><?php echo isset($this->vars['L_USERNAME']) ? $this->vars['L_USERNAME'] : $this->lang('L_USERNAME'); ?></td>
    <td class="row2"><input type="text" class="post" name="username" style="width:30%; padding-left:7px; letter-spacing:1px;" tabindex="1" value="<?php echo isset($this->vars['USERNAME']) ? $this->vars['USERNAME'] : $this->lang('USERNAME'); ?>" />&nbsp;<input style="border:1px solid black; cursor:pointer; text-transform: uppercase;" type="submit" name="usersubmit" value="<?php echo isset($this->vars['L_FIND_USERNAME']) ? $this->vars['L_FIND_USERNAME'] : $this->lang('L_FIND_USERNAME'); ?>" class="titaniumbutton" onclick="window.open('<?php echo isset($this->vars['U_SEARCH_USER']) ? $this->vars['U_SEARCH_USER'] : $this->lang('U_SEARCH_USER'); ?>', '_phpbbsearch', 'HEIGHT=250,resizable=yes,WIDTH=400');return false;" /></td>
  </tr>
  <?php
...
?>
  ...
  <tr> 
    ...
    <td class="row2" style="width: 80%"><input type="text" name="subject" size="45" maxlength="120" style="width:98.8%; fpadding-left:7px; letter-spacing:1px;" tabindex="2" class="post" value="<?php echo isset($this->vars['SUBJECT']) ? $this->vars['SUBJECT'] : $this->lang('SUBJECT'); ?>" /></td>
  </tr>
  <?php
...
?>
  ...
  <tr> 
    <td style="height:30px; text-align:center;" class="catBottom" colspan="2">
      ...
      <input type="submit" tabindex="5" name="preview" id="preview" class="titaniumbutton" value="<?php echo isset($this->vars['L_PREVIEW']) ? $this->vars['L_PREVIEW'] : $this->lang('L_PREVIEW'); ?>" />
      <input type="submit" id="submit" accesskey="s" tabindex="6" name="post" class="titaniumbutton" value="<?php echo isset($this->vars['L_SUBMIT']) ? $this->vars['L_SUBMIT'] : $this->lang('L_SUBMIT'); ?>" />
    </td>
  </tr>
</table>
